...
USER_AGREEMENT_TEXT = (
    ...
    "использования сервиса Anyport VPN "
    "(далее — «Сервис»). Используя Сервис, "
    "пользователь подтверждает согласие "
    "с условиями настоящего Соглашения.\n\n"

    "1. Общие положения\n"
    "• Сервис предоставляет пользователям "
    "программный доступ к VPN-подключению "
    "для повышения безопасности и "
    "конфиденциальности интернет-соединения.\n"

    "• Доступ к Сервису предоставляется "
    "на платной основе в формате подписки "
    "на определённый срок.\n"

    "• Использование Сервиса допускается "
    "исключительно в законных целях.\n"

    "• Использование Сервиса означает "
    "полное и безоговорочное принятие "
    "условий настоящего Соглашения.\n\n"

    "2. Предоставление услуг\n"
    "• После успешной оплаты пользователь "
    "получает доступ к функционалу Сервиса "
    "автоматически либо в течение "
    "разумного технического времени.\n"

    "• Услуга считается оказанной "
    "с момента предоставления доступа "
    "к Сервису.\n"

    "• Срок действия подписки определяется "
    "выбранным тарифом.\n\n"
    ...
    "• не распространять вредоносное "
    "программное обеспечение, спам, "
    "запрещённый контент;\n"

    "• не предпринимать действий, "
    "нарушающих работоспособность Сервиса;\n"

    "• соблюдать законодательство "
    "страны использования Сервиса.\n\n"
    ...
    "• получать информацию "
    "об изменениях условий использования "
    "Сервиса.\n\n"
    ...
    "технических проблем, препятствующих "
    ...
    "не гарантирует бесперебойную "
    "и безошибочную работу Сервиса.\n"

    "• Администрация не несёт "
    "ответственности за ограничения "
    "доступа к сети Интернет, действия "
    "третьих лиц, провайдеров связи "
    "либо программного обеспечения "
    "пользователя.\n"

    "• Пользователь самостоятельно "
    "несёт ответственность за сохранность "
    "своих данных доступа.\n\n"
    ...
    "• Сервис принимает разумные меры "
    "для защиты пользовательских данных "
    "и безопасности соединения.\n"

    "• Платёжные данные пользователей "
    "обрабатываются исключительно "
    "платёжными системами.\n\n"

    "8. Изменение условий\n"
    "• Администрация Сервиса вправе "
    "изменять настоящее Соглашение "
    "без предварительного уведомления.\n"

    "• Актуальная версия Соглашения "
    "публикуется в официальных ресурсах "
    "Сервиса.\n"

    "• Продолжение использования Сервиса "
    "после внесения изменений означает "
